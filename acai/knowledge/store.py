"""Persistent knowledge-document storage (filesystem).
...
from .models import Facets, KnowledgeDoc, slugify
...
class KnowledgeStore:
    ...
    def subsubjects(self, subject: str) -> list[str]:
        ...
        subject_dir = os.path.join(self.base, slugify(subject))
    ...
    def _titles_in(self, subject: str, subsubject: str) -> list[str]:
        d = os.path.join(self.base, slugify(subject), slugify(subsubject))
