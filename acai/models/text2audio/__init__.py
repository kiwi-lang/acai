...
from acai.tools import namespaced_route
...
def routes(app: ACAI, db):
    ...
    #
    route = namespaced_route(app, '/text2audio')

    @route("/model/download/<string:name>")
    def download_model_t2a(name):
    ...
    def delete_model_t2a(name):
        """Delete a local model"""

    @route("/model/list>")
    def list_model_t2a(name):
