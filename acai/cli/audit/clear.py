...
Usage::
    ...
    acai audit clear             # keep last 10 (default)
    acai audit clear --keep 0    # delete everything
    acai audit clear --keep 20   # keep last 20
"""
...
from acai.cli.audit import audit_dirs
