...
Usage::
    ...
    acai audit              # list recent audits
    acai audit clear        # delete all audit data
    acai audit plot         # save timeline PNG and open it
"""
...
class Audit(ParentCommand):
    ...
    @staticmethod
    def module():
        import acai.cli.audit
        return acai.cli.audit
