...
Node types are loaded from the :mod:`acai.tasks.nodes` registry.
...
from acai.tasks.nodes import NodeContext
...
class DynamicGraph(TaskGraph):
    ...
    Node behaviour is delegated to :class:`~acai.tasks.nodes.NodeType`
