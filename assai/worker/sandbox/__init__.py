...
Each backend exposes an ``assai mcp`` tool server (HTTP) running
...
Usage::
    ...
    cfg = SandboxConfig(type="docker", image="assai-sandbox", mcp_port=9200)
...
from assai.worker.sandbox.base import (
    Sandbox,
    create_sandbox,
)
