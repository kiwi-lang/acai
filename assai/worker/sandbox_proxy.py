...
class SandboxProxy:
    ...
    ----------
    default_config:
        System-wide :class:`SandboxConfig` (from ``AssaiConfig.sandbox``).
    sandbox_predicate:
    ...
    def _ensure_started(self, ctx: dict) -> None:
        ...
        from assai.worker.sandbox import create_sandbox
        ...
        workspace = os.environ.get("ASSAI_WORKSPACE", os.getcwd())
